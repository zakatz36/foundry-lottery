...
contract FundSubscription is Script, CodeConstants {
    ...
    bool public subscriptionFundedForTesting;
        ...
        public
    {
        ...
        if (block.chainid == LOCAL_CHAIN_ID) {
            ...
            vm.stopBroadcast();
            subscriptionFundedForTesting = true;
        } else {
            vm.startBroadcast(account);
...
contract AddConsumer is Script {
    ...
    bool public consumerAddedForTesting;
    ...
    function addConsumer(address contractToAddtoVrf, address vrfCoordinator, uint256 subId, address account) public {
        ...
        consumerAddedForTesting = true;
        vm.stopBroadcast();
    }

    function run() external {
        mostRecentlyDeployed = DevOpsTools.get_most_recent_deployment("Raffle", block.chainid);
